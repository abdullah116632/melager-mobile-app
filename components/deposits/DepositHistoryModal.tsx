...
export const DepositHistoryModal = ({
  ...
  const historyEntries = consumerId
    ? getConsumerDepositEntries(entries, consumerId)
        .slice()
        // Oldest first, so the list reads as the order the deposits were made.
        .sort(
          (first, second) =>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <View className="pb-safe-offset-5 max-h-[75%] rounded-t-3xl bg-white px-5 pt-5 shadow-2xl shadow-black/10">
